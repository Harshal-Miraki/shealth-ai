        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
            ...
            >
                ...
                <DashboardHeader
                    ...
                    subtitle={t.auth.layout.mobileSubtitle}
                />
                ...
                <main className="p-6 lg:p-8">
                    ...
                    <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900 mb-2">
                                {t.dashboardHome.welcome} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent)]"> Dr. {currentUser?.name}</span>
                            </h1>
                    ...
                    {/* Quick Upload Card */}
                    <div className="bg-[#1EE1F3] border-2 border-[#00B5C5] rounded-2xl p-6 mb-8 text-white relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h3 className="text-xl text-black/80 font-bold mb-1">{t.dashboardHome.readyToAnalyze}</h3>
                                <p className="text-black/80 text-sm">{t.dashboardHome.uploadDesc}</p>
                            </div>
                            <Link href="/dashboard/upload">
