          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[var(--color-surface)] border border-slate-200 rounded-full mb-8 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <span className="text-xs font-semibold text-slate-600 tracking-wide uppercase">FDA-Cleared Architecture</span>
              </div>
              ...
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                Empowering comprehensive care with enterprise-grade AI.
                Shealth AI transforms standard DICOM data into actionable clinical intelligence—instantly.
              </p>
            ...
            <div className="w-full lg:w-1/2 relative perspective-1000 animate-in fade-in zoom-in duration-1000 delay-300">
              <div className="relative z-10 transform lg:rotate-y-[-5deg] lg:rotate-x-[2deg] transition-transform duration-500 hover:rotate-0">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg shadow-xl border border-slate-100 flex items-center gap-4 animate-bounce-slow hidden md:flex">
                  ...
                  <div>
                    <p className="text-xs text-slate-400 font-semibold uppercase">Analysis Complete</p>
                    <p className="font-bold text-slate-800">No Anomalies Found</p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              Our platform seamlessly fits into your existing PACS workflow, adding layers of proprietary intelligence without disrupting your clinic's rhythm.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <FeatureCard
              ...
              description="Advanced AI analyzes MRI, CT, and X-ray scans to detect patterns and abnormalities with high accuracy."
              gradient="bg-gradient-to-br from-[var(--color-primary)] to-blue-600"
            />
            <FeatureCard
              icon={<BarChart3 className="w-8 h-8 text-white" />}
              title="Predictive Analytics"
              description="Track patient health trends over time and identify potential issues before they become serious."
              gradient="bg-gradient-to-br from-indigo-500 to-purple-600"
            />
            <FeatureCard
              icon={<Zap className="w-8 h-8 text-white" />}
              title="Real-Time Triage"
              description="Automatically prioritize urgent cases and flag critical findings for immediate attention."
      ...
      <footer className="bg-slate-950 text-slate-400 py-20 border-t border-slate-900">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><a href="#" className="hover:text-[var(--color-accent)] transition-colors">Integrations</a></li>
                <li><a href="#" className="hover:text-[var(--color-accent)] transition-colors">Security</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-600">
            <p>© 2024 Shealth AI Inc. All rights reserved.</p>
