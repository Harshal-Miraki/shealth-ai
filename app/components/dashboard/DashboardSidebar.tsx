...
const getNavItems = (t: any) => [
    ...
    { icon: Upload, label: t.dashboard.sidebar.upload, href: "/dashboard/upload" },
    { icon: History, label: t.dashboard.sidebar.history, href: "/dashboard/history" },
    { icon: BarChart3, label: t.dashboard.sidebar.statistics, href: "/dashboard/analytics" },
                                ...
                                <Link
                                    ...
                                    className={`
                                        ...
                                        ${isActive
                                            ...
                                            : "text-black hover:text-white hover:bg-slate-800/50"
                                        }
                                    `}
                                >
                                    {/* Active indicator */}
            ...
            <div className="p-4 border-t border-slate-800/50">
                <div className={`flex items-center gap-3 ${isCollapsed ? "justify-center" : ""}`}>
                    ...
                    <div
                        ...
                        `}
                    >
                        <p className="text-sm font-semibold text-white truncate">{currentUser?.name || 'Guest User'}</p>
